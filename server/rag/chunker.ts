// Troceado de documentos para la Biblioteca de Miguel: fragmentos de tamaño
// acotado con solapamiento, cortando en límites naturales (párrafo, línea,
// frase, espacio) para no partir ideas a mitad.
...
export function chunkText(text: string, options: ChunkOptions = {}): string[] {
  ...
  while (start < normalized.length) {
    ...
    if (end < normalized.length) end = findBreak(normalized, start, end);
...
/** Mejor punto de corte en la segunda mitad de la ventana [start, end). */
