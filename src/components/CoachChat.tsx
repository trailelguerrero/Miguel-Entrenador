          ...
          return (
            ...
            >
              ...
              >
                ...
                {!isUser && !!msg.knowledgeSources?.length && (
                  <div className="pt-2 border-t border-zinc-900 text-[10px] text-zinc-400 space-y-0.5">
                    <div className="flex items-center space-x-1 font-bold uppercase tracking-wider text-emerald-400">
                      <BookOpen className="w-3 h-3" />
                      <span>Biblioteca de Miguel</span>
                    </div>
                    {msg.knowledgeSources.map((s, i) => (
                      <div key={i}>
                        [B{i + 1}] {s.title}
                        {s.source ? ` · ${s.source}` : ''}
                      </div>
                ...
                {!isUser && msg.knowledgeWarning && (
                  <div className="pt-2 border-t border-zinc-900 text-[10px] text-amber-400">
